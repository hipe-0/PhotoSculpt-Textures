#include "Trace.h"
	...
	*/
	...
	#define NANOBEGIN   DEBUG_WRITE("NB");  __asm _emit 0xEB __asm _emit 0x03 __asm _emit 0xD6 __asm _emit 0xD7 __asm _emit 0x01 ; DEBUG_WRITE("/NANOBEGIN");
	#define NANOEND     DEBUG_WRITE("NE");    __asm _emit 0xEB __asm _emit 0x03 __asm _emit 0xD6 __asm _emit 0xD7 __asm _emit 0x00 ; DEBUG_WRITE("/NANOEND");
#endif
