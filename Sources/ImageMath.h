...
inline int maxint(int a, int b) { if (a>b) return a; else return b; }
...
#define ChannelBlend_Add(B,L)        ((uint8)(minint(255, (B + L))))
...
#define ChannelBlend_ColorDodge(B,L) ((uint8)((L == 255) ? L:minint(255, ((B << 8 ) / (255 - L)))))
#define ChannelBlend_ColorBurn(B,L)  ((uint8)((L == 0) ? L:maxint(0, (255 - ((255 - B) << 8 ) / L))))
...
#define ChannelBlend_Reflect(B,L)    ((uint8)((L == 255) ? L:minint(255, (B * B / (255 - L)))))
#define ChannelBlend_Glow(B,L)       (ChannelBlend_Reflect(L,B))
#define ChannelBlend_Phoenix(B,L)    ((uint8)(minint(B,L) - maxint(B,L) + 255))
